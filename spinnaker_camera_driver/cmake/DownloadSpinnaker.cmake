function(download_spinnaker FLIR_LIB_VAR FLIR_INCLUDE_DIR_VAR)
  ...
  message(STATUS "Running download_spinnaker script with arguments: ${FLIR_ARCH} ${CATKIN_DEVEL_PREFIX}/lib/spinnaker_camera_driver/ ${OS_CODE_NAME}")
  set(DOWNLOAD_SCRIPT "${PROJECT_SOURCE_DIR}/cmake/download_spinnaker")
  execute_process(
    COMMAND ${DOWNLOAD_SCRIPT} ${FLIR_ARCH} "${CATKIN_DEVEL_PREFIX}/lib/spinnaker_camera_driver/" ${OS_CODE_NAME})
